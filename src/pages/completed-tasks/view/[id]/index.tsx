...
import { getCompletedTaskById } from 'apiSdk/completed-tasks';
...
function CompletedTaskViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Completed Task Detail View
          </Text>
          {hasAccess('completed_task', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/completed-tasks/edit/${data?.id}`} passHref legacyBehavior>
              <Button
            ...
            <Box>
              {hasAccess('student_roadmap', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Flex alignItems="center" mb={4}>
                  ...
                  <Text fontSize="md" as="span" ml={3}>
                    <Link as={NextLink} href={`/student-roadmaps/view/${data?.student_roadmap?.id}`}>
                      {data?.student_roadmap?.id}
                    </Link>
                  </Text>
                </Flex>
              )}
